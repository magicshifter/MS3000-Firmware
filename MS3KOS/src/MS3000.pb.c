...
const char MS3KG_Modes_Light_name_default[1337] = "light";
...
const pb_field_t MS3KG_Modes_Light_fields[4] = {
    PB_FIELD(  1, STRING  , REQUIRED, STATIC  , FIRST, MS3KG_Modes_Light, name, name, &MS3KG_Modes_Light_name_default),
...
#error Field descriptor for MS3KG_Modes_Light.name is too large. Define PB_FIELD_16BIT to fix this.
#endif

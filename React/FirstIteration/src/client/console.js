...
export function measureRender(callback) {
  const measureRenderEnabled = isBrowser && window.msState.measureRender;
...
if (isBrowser) {
  ...
  document.addEventListener('keypress', e => {
    ...
    switch (e.keyCode) {
      // ctrl+shift+l
      case 12: msState.loadState(); break; // eslint-disable-line no-undef
      // ctrl+shift+s
      case 19: msState.saveState(); break; // eslint-disable-line no-undef
    }
  });

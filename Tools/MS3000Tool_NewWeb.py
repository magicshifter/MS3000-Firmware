...
def initMS3000():
	...
	issueUploadMS3000(ser, "../../MS3000-Assets/MS3000_defaultconfig/admin.html", "admin.html")
        sleep(delay)
        issueUploadMS3000(ser, "../../MS3000-WebInterface/ms3000-app/build/grids-responsive-min.css", "grids-responsive-min.css")
        sleep(delay)
        issueUploadMS3000(ser, "../../MS3000-WebInterface/ms3000-app/build/favicon.ico", "favicon.ico")
        sleep(delay)
        issueUploadMS3000(ser, "../../MS3000-WebInterface/ms3000-app/build/theme.css", "theme.css")
        sleep(delay)
        issueUploadMS3000(ser, "../../MS3000-WebInterface/ms3000-app/build/index.html", "index.html")
        sleep(delay)
        issueUploadMS3000(ser, "../../MS3000-WebInterface/ms3000-app/build/asset-manifest.json", "asset-manifest.json")
        sleep(delay)
        issueUploadMS3000(ser, "../../MS3000-WebInterface/ms3000-app/build/pure-grid-min.css", "pure-grid-min.css")
        sleep(delay)
        issueUploadMS3000(ser, "../../MS3000-WebInterface/ms3000-app/build/MS3000.proto", "MS3000.proto")
        sleep(delay)
        issueUploadMS3000(ser, "../../MS3000-WebInterface/ms3000-app/build/static/css/main.8fb3b1dc.css", "static/css/main.8fb3b1dc.css")
        sleep(delay)
        issueUploadMS3000(ser, "../../MS3000-WebInterface/ms3000-app/build/static/js/main.e142e67a.js", "static/js/main.e142e67a.js")
        sleep(delay)
        issueUploadMS3000(ser, "../../MS3000-WebInterface/ms3000-app/build/pure-min.css", "pure-min.css")
        sleep(delay)

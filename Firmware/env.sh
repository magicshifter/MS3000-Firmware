...
export MS3KOS_BUILD_DIR=/home/ibisum/Documents/builds/MagicShifter3000/MS3KOS_BUILD 
...
alias flashwait="while \$(inotifywait -q -q $MS3KOS_BUILD_DIR/MS3KOS.bin) ; do echo "flashingit::" && flashit && Tools/espTerm.py ; done"
alias codewait="while \$(inotifywait -e modify  -q -q -r MS3KOS/); do echo "buildingit::" && make all; done"
alias ide="cscope -R -s $ESP8266COM_BASEDIR"
